...
interface AdministratorSidebarLayoutProps {
  children: React.ReactNode;
}

const AdministratorSidebarLayout: React.FC<AdministratorSidebarLayoutProps> = ({ children }) => {
  ...
  const sidebarItems = [
    ...
    },
    {
      title: 'Levels',
      path: '/admin/levels',
      icon: <Layers size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Categories',
      path: '/admin/categories',
      icon: <Briefcase size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Semesters',
      path: '/admin/semesters',
      icon: <CalendarDays size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Units',
      path: '/admin/units',
      icon: <BookOpen size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Modules',
      path: '/admin/modules',
      icon: <Layout size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Sections',
      path: '/admin/sections',
      icon: <BookOpenText size={20} className="transition-colors duration-300" />
    },
    {
      title: 'Groups',
      path: '/admin/groups',
    ...
    },
    {
      ...
      path: '/admin/users',
      icon: <Users size={20} className="transition-colors duration-300" />
    },
    // Removed Profile and Settings from sidebar as they'll be in dropdown now
  ];
  ...
  const renderSidebar = () => (
    ...
    >
      <div className="flex items-center justify-between p-4 border-b border-border">
        {isSidebarOpen && (
          <Link to="/admin/dashboard" className="text-xl font-bold text-[#2563EB] dark:text-white transition-colors hover:text-[#2563EB] dark:hover:text-[#b3b3ff]">
            Admin Panel
          </Link>
        )}
        <Button
...
export default AdministratorSidebarLayout;
